...
// ---- المحتوى الرئيسي (مُغلَّف بـ Suspense) ----
function ChatContent() {
  ...
  useEffect(() => {
    if (!conversationId || !getToken()) return
  ...
  const sendMessage = async (text?: string) => {
    ...
    try {
      ...
      // حدّث القائمة إن كانت محادثة جديدة
      if (!conversationId) {
        ...
        {showSidebar && (
          <div style={{
            ...
            <div style={{
              ...
              <span style={{ color: T.mutedCol, fontSize: 13 }}>
            ...
            {conversations.length === 0 ? (
              <div style={{ padding: 20, textAlign: 'center', color: T.mutedCol }}>
                ...
                <p style={{ fontSize: 13, color: T.mutedCol, marginTop: 8 }}>
                  ابدأ محادثة جديدة للتواصل مع مداد
                </p>
              </div>
            ) : (
              conversations.map(conv => (
                <button
                  ...
                  style={{
                    display: 'block',
                    width: '100%',
                    background: conversationId === conv.id ? T.primarySoft : 'transparent',
                    border: 'none',
                    borderBottom: '1px solid ' + T.borderCol,
                    padding: '12px 16px',
                    textAlign: 'right',
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  {QUICK_SUGGESTIONS.map((s, i) => (
                    <button
                      key={i}
                      onClick={() => handleSuggestion(s.replace(/^[^\s]+/, ''))}
                      style={{
                        background: T.cardBg,
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: 8, alignItems: 'flex-end' }}>
              ...
              <button
                ...
                style={{
                  background: isSending ? T.mutedCol : T.primary,
                  color: '#fff',
                  border: 'none',
                  borderRadius: 12,
                  width: 48,
