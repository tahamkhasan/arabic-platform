    ...
    <div className="fade-in" style={sectionCard}>
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap', marginBottom: 20 }}>
        <div>
          ...
          <p style={{ margin: 0, fontSize: 13, color: T.subCol }}>إضافة المعلمين، اعتماد الحسابات، وربط المواد ونطاقات التدريس.</p>
        </div>
      ...
      <div className="admin-stats-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(2,1fr)', gap: 14, marginBottom: 24 }}>
        {[
          ...
          { label: 'بانتظار الموافقة', value: teacherPendingCount, color: BRAND.red, icon: '⏳' },
        ].map((s, i) => (
          <div
            key={i}
            style={{
      ...
      <div style={{ display: 'flex', gap: 10, marginBottom: 16, flexWrap: 'wrap' }}>
        ...
        >
          ...
          <option value="pending">بانتظار الموافقة ({teacherPendingCount})</option>
        </select>
      </div>
